...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa HTTP Symfony',
    nsPrefix: 'Milpa\\Http\\Symfony\\',
    installCommand: 'composer require milpa/http-symfony',
    repoUrl: 'https://github.com/getmilpa/http-symfony',
    pagesUrl: 'https://getmilpa.github.io/http-symfony/',
    heroParagraph: 'The <strong>Symfony HttpFoundation adapter</strong> for Milpa — the response value objects and the base controller a host\'s routing invokes. <code>milpa/http</code> describes routes and handlers without committing to any HTTP implementation; this package is one implementation of the other half: what a controller <em>returns</em>.',
    utmContent: 'http-symfony',
);
